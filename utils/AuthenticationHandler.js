...
//   async onLogin() {
//     try {
//       const authUrl = `${this.spotifyAuthConfig.issuer}/authorize?client_id=${
//         this.spotifyAuthConfig.clientId
//       }&redirect_uri=${encodeURIComponent(
//         this.spotifyAuthConfig.redirectUrl
//       )}&response_type=code&scope=${this.spotifyAuthConfig.scopes.join("%20")}`;
